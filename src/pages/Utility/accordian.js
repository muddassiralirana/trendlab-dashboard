      ...
      <React.Fragment>
        <Card>
          ...
          <Collapse isOpen={this.state.col1}>
            <CardBody>{this.props.answer1}</CardBody>
          </Collapse>
        </Card>
        <Card>
          ...
          <Collapse isOpen={this.state.col2}>
            <CardBody>{this.props.answer2}</CardBody>
          </Collapse>
        </Card>
        <Card>
          ...
          <Collapse isOpen={this.state.col3}>
            <CardBody>{this.props.answer3}</CardBody>
          </Collapse>
        </Card>
        <Card>
          ...
          <Collapse isOpen={this.state.col4}>
            <CardBody>{this.props.answer4}</CardBody>
          </Collapse>
        </Card>
        <Card>
          ...
          <Collapse isOpen={this.state.col5}>
            <CardBody>{this.props.answer5}</CardBody>
          </Collapse>
        </Card>
      </React.Fragment>
    );
