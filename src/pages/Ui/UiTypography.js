                  ...
                  <CardBody>
                    ...
                    <h1 className="mb-3">
                      ...
                      <small className="text-muted">
                        Semibold 2.0325rem (32.52px)
                      </small>
                    </h1>
                    <h2 className="mb-3">
                      h2. Bootstrap heading{' '}
                      <small className="text-muted">
                        Semibold 1.626rem (26.016px)
                      </small>
                    </h2>
                    <h3 className="mb-3">
                      h3. Bootstrap heading{' '}
                      <small className="text-muted">
                        Semibold 1.42275rem (22.764px)
                      </small>
                    </h3>
                    <h4 className="mb-3">
                      h4. Bootstrap heading{' '}
                      <small className="text-muted">
                        Semibold 1.2195rem (19.512px)
                      </small>
                    </h4>
                    <h5 className="mb-3">
                      h5. Bootstrap heading{' '}
                      <small className="text-muted">
                        Semibold 1.01625rem (16.26px)
                      </small>
                    </h5>
                    <h6 className="mb-3">
                      h6. Bootstrap heading{' '}
                      <small className="text-muted">
                        Semibold 0.813rem (13.008px)
                      </small>
                    </h6>
                  </CardBody>
                </Card>
