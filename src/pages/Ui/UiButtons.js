              ...
              <Col xl={6}>
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      Add Property size=""<code>lg</code> or <code>sm</code> for
                      additional sizes.
                    </p>
                    ...
                    <div className="button-items">
                      ...
                      <Button color="light" size="sm" className="waves-effect">
                        Small button
                      </Button>
                    </div>
                  </CardBody>
                  ...
                  <CardBody>
                    ...
                    <div className="button-items">
                      ...
                      <Button
                        type="button"
                        color="danger"
                        className="w-sm waves-effect waves-light me-1"
                      >
                        Small
                      </Button>
                      <Button
                        type="button"
                        color="warning"
                        className="w-md waves-effect waves-light me-1"
                      >
                        Medium
                      </Button>
                      <Button
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      of a parent—by adding property{' '}
                      <code className="highlighter-rouge">block</code>.
                    </p>
                ...
                <Card>
                  <CardBody>
                    ...
                    <p className="card-title-desc">
                      ...
                      in a group, just add property size=""
